...
$sql = "SELECT p.id_proses, m.nama_mahasiswa, m.nim, pr.nama_prodi, f.nama_fakultas, p.status_proses FROM proses_wisuda p JOIN mahasiswa m ON p.id_mahasiswa = m.id_mahasiswa JOIN prodi pr ON m.id_prodi = pr.id_prodi JOIN fakultas f ON pr.id_fakultas = f.id_fakultas ORDER BY p.id_proses DESC";
